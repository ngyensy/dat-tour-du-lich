...
const DiscountCodeComponent = ({ totalPrice, setFinalPrice }) => {
  ...
  const handleApplyDiscount = async () => {
    ...
    try {
      ...
      if (response.data.message === "Mã giảm giá hợp lệ.") {
        ...
        setAppliedCode(discountCode);  // Lưu mã giảm giá đã áp dụng
  ...
  return (
    <div className="discount-section flex items-center gap-3 border-y-2 py-4 border-gray-500">
